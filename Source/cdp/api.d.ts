...
export namespace Cdp {
	...
	export interface DotnetDebuggerApi {
		...
		on(
			...
			listener: (
				event: DotnetDebugger.ReportBlazorDebugErrorEvent,
			) => void,
		): IDisposable;
	}
	...
	export interface FedCmApi {
		...
		openUrl(
			params: FedCm.OpenUrlParams,
		): Promise<FedCm.OpenUrlResult | undefined>;
		...
		on(
			event: "dialogClosed",
			listener: (event: FedCm.DialogClosedEvent) => void,
		): IDisposable;
	}
	...
	export interface StorageApi {
		...
		on(
			...
			listener: (
				event: Storage.InterestGroupAuctionEventOccurredEvent,
			) => void,
		): IDisposable;
		...
		on(
			...
			listener: (
				event: Storage.InterestGroupAuctionNetworkRequestCreatedEvent,
			) => void,
		): IDisposable;
		...
		on(
			...
			listener: (
				event: Storage.AttributionReportingTriggerRegisteredEvent,
			) => void,
		): IDisposable;
	}
	...
	export namespace Storage {
		 ...
		 */
		export type InterestGroupAuctionEventType =
			| "started"
			| "configResolved";
