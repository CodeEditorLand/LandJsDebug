...
export namespace Dap {
	...
	export interface Api {
		...
		on(
			...
			) => Promise<NetworkCallResult | Error>,
		): () => void;
		/**
		 * Makes a network call. There is little abstraction here because UI interacts literally with CDP at the moment.
		 */
		...
		on(
			...
			handler: (
				params: EnableNetworkingParams,
			) => Promise<EnableNetworkingResult | Error>,
		): () => void;
		/**
		 * Attempts to enable networking on the target.
		 */
		enableNetworkingRequest(
			params: EnableNetworkingParams,
		): Promise<EnableNetworkingResult>;
